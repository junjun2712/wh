...
extern string pairs = "EURAUD-EURCAD-EURJPY-EURNZD-GBPAUD-GBPCAD-GBPCHF-GBPJPY-GBPNZD-GBPUSD-XAUUSD-UK100-WS30-NDX100";
extern string TFs = "M15-H1-H4-D1-W1";
...
extern double rsi_high_level = 60;
extern double rsi_low_level = 40;
...
if(data>=rsi_high_level) col=Rectangle_color_up;
else
if(data<=rsi_low_level) col=Rectangle_color_down;
else
